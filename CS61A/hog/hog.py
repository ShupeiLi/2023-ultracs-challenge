...
def tail_points(opponent_score):
    ...
    # BEGIN PROBLEM 2
    # "*** YOUR CODE HERE ***"
    preprocess_score = opponent_score % 100
    tens = preprocess_score // 10
    ones = preprocess_score % 10
...
def play(strategy0, strategy1, update,
    ...
    while score0  < goal and score1 < goal:
        if who == 0:
            ...
            raise Exception(f'variable "who" is not correct: {who}.')
        who = abs(who - 1)
    # END PROBLEM 5
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    Set threshold to the expected value of rolling 6.
    """
    # BEGIN PROBLEM 12
    if (square_update(0, score, opponent_score) - score) >= make_averaged(always_roll(6))(score, opponent_score):
        return 0
    else:
        return 6
    # END PROBLEM 11
